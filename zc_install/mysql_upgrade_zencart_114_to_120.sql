...
INSERT INTO product_type_layout (configuration_title, configuration_key, configuration_value, configuration_description, product_type_id, sort_order, set_function, date_added) VALUES ('Show Product Tell a Friend button', 'SHOW_PRODUCT_MUSIC_INFO_TELL_A_FRIEND', '0', 'Display the Tell a Friend button on Product Info<br /><br />Note: Turning this setting off does not affect the Tell a Friend box in the columns and turning off the Tell a Friend box does not affect the button<br />0= off 1= on', '2', '15', 'zen_cfg_select_drop_down(array(array(\'id\'=>\'1\', \'text\'=>\'True\'), array(\'id\'=>\'0\', \'text\'=>\'False\')), ', now());
...
INSERT INTO product_type_layout (configuration_title, configuration_key, configuration_value, configuration_description, product_type_id, sort_order, set_function, date_added) VALUES ('Show Product Tell a Friend button', 'SHOW_DOCUMENT_GENERAL_INFO_TELL_A_FRIEND', '0', 'Display the Tell a Friend button on Product Info<br /><br />Note: Turning this setting off does not affect the Tell a Friend box in the columns and turning off the Tell a Friend box does not affect the button<br />0= off 1= on', '3', '15', 'zen_cfg_select_drop_down(array(array(\'id\'=>\'1\', \'text\'=>\'True\'), array(\'id\'=>\'0\', \'text\'=>\'False\')), ', now());
...
INSERT INTO product_type_layout (configuration_title, configuration_key, configuration_value, configuration_description, product_type_id, sort_order, set_function, date_added) VALUES ('Show Product Tell a Friend button', 'SHOW_PRODUCT_FREE_SHIPPING_INFO_TELL_A_FRIEND', '0', 'Display the Tell a Friend button on Product Info<br /><br />Note: Turning this setting off does not affect the Tell a Friend box in the columns and turning off the Tell a Friend box does not affect the button<br />0= off 1= on', '5', '15', 'zen_cfg_select_drop_down(array(array(\'id\'=>\'1\', \'text\'=>\'True\'), array(\'id\'=>\'0\', \'text\'=>\'False\')), ', now());
...
#####################################
UPDATE zones SET zone_code='北海道' WHERE zone_country_id='107' AND zone_code='01' AND zone_name='北海道';
UPDATE zones SET zone_code='青森県' WHERE zone_country_id='107' AND zone_code='02' AND zone_name='青森県';
UPDATE zones SET zone_code='岩手県' WHERE zone_country_id='107' AND zone_code='03' AND zone_name='岩手県';
UPDATE zones SET zone_code='宮城県' WHERE zone_country_id='107' AND zone_code='04' AND zone_name='宮城県';
UPDATE zones SET zone_code='秋田県' WHERE zone_country_id='107' AND zone_code='05' AND zone_name='秋田県';
UPDATE zones SET zone_code='山形県' WHERE zone_country_id='107' AND zone_code='06' AND zone_name='山形県';
UPDATE zones SET zone_code='福島県' WHERE zone_country_id='107' AND zone_code='07' AND zone_name='福島県';
UPDATE zones SET zone_code='茨城県' WHERE zone_country_id='107' AND zone_code='08' AND zone_name='茨城県';
UPDATE zones SET zone_code='栃木県' WHERE zone_country_id='107' AND zone_code='09' AND zone_name='栃木県';
UPDATE zones SET zone_code='群馬県' WHERE zone_country_id='107' AND zone_code='10' AND zone_name='群馬県';
UPDATE zones SET zone_code='埼玉県' WHERE zone_country_id='107' AND zone_code='11' AND zone_name='埼玉県';
UPDATE zones SET zone_code='千葉県' WHERE zone_country_id='107' AND zone_code='12' AND zone_name='千葉県';
UPDATE zones SET zone_code='東京都' WHERE zone_country_id='107' AND zone_code='13' AND zone_name='東京都';
UPDATE zones SET zone_code='神奈川県' WHERE zone_country_id='107' AND zone_code='14' AND zone_name='神奈川県';
UPDATE zones SET zone_code='新潟県' WHERE zone_country_id='107' AND zone_code='15' AND zone_name='新潟県';
UPDATE zones SET zone_code='富山県' WHERE zone_country_id='107' AND zone_code='16' AND zone_name='富山県';
UPDATE zones SET zone_code='石川県' WHERE zone_country_id='107' AND zone_code='17' AND zone_name='石川県';
UPDATE zones SET zone_code='福井県' WHERE zone_country_id='107' AND zone_code='18' AND zone_name='福井県';
UPDATE zones SET zone_code='山梨県' WHERE zone_country_id='107' AND zone_code='19' AND zone_name='山梨県';
UPDATE zones SET zone_code='長野県' WHERE zone_country_id='107' AND zone_code='20' AND zone_name='長野県';
UPDATE zones SET zone_code='岐阜県' WHERE zone_country_id='107' AND zone_code='21' AND zone_name='岐阜県';
UPDATE zones SET zone_code='静岡県' WHERE zone_country_id='107' AND zone_code='22' AND zone_name='静岡県';
UPDATE zones SET zone_code='愛知県' WHERE zone_country_id='107' AND zone_code='23' AND zone_name='愛知県';
UPDATE zones SET zone_code='三重県' WHERE zone_country_id='107' AND zone_code='24' AND zone_name='三重県';
UPDATE zones SET zone_code='滋賀県' WHERE zone_country_id='107' AND zone_code='25' AND zone_name='滋賀県';
UPDATE zones SET zone_code='京都府' WHERE zone_country_id='107' AND zone_code='26' AND zone_name='京都府';
UPDATE zones SET zone_code='大阪府' WHERE zone_country_id='107' AND zone_code='27' AND zone_name='大阪府';
UPDATE zones SET zone_code='兵庫県' WHERE zone_country_id='107' AND zone_code='28' AND zone_name='兵庫県';
UPDATE zones SET zone_code='奈良県' WHERE zone_country_id='107' AND zone_code='29' AND zone_name='奈良県';
UPDATE zones SET zone_code='和歌山県' WHERE zone_country_id='107' AND zone_code='30' AND zone_name='和歌山県';
UPDATE zones SET zone_code='鳥取県' WHERE zone_country_id='107' AND zone_code='31' AND zone_name='鳥取県';
UPDATE zones SET zone_code='島根県' WHERE zone_country_id='107' AND zone_code='32' AND zone_name='島根県';
UPDATE zones SET zone_code='岡山県' WHERE zone_country_id='107' AND zone_code='33' AND zone_name='岡山県';
UPDATE zones SET zone_code='広島県' WHERE zone_country_id='107' AND zone_code='34' AND zone_name='広島県';
UPDATE zones SET zone_code='山口県' WHERE zone_country_id='107' AND zone_code='35' AND zone_name='山口県';
UPDATE zones SET zone_code='徳島県' WHERE zone_country_id='107' AND zone_code='36' AND zone_name='徳島県';
UPDATE zones SET zone_code='香川県' WHERE zone_country_id='107' AND zone_code='37' AND zone_name='香川県';
UPDATE zones SET zone_code='愛媛県' WHERE zone_country_id='107' AND zone_code='38' AND zone_name='愛媛県';
UPDATE zones SET zone_code='高知県' WHERE zone_country_id='107' AND zone_code='39' AND zone_name='高知県';
UPDATE zones SET zone_code='福岡県' WHERE zone_country_id='107' AND zone_code='40' AND zone_name='福岡県';
UPDATE zones SET zone_code='佐賀県' WHERE zone_country_id='107' AND zone_code='41' AND zone_name='佐賀県';
UPDATE zones SET zone_code='長崎県' WHERE zone_country_id='107' AND zone_code='42' AND zone_name='長崎県';
UPDATE zones SET zone_code='熊本県' WHERE zone_country_id='107' AND zone_code='43' AND zone_name='熊本県';
UPDATE zones SET zone_code='大分県' WHERE zone_country_id='107' AND zone_code='44' AND zone_name='大分県';
UPDATE zones SET zone_code='宮崎県' WHERE zone_country_id='107' AND zone_code='45' AND zone_name='宮崎県';
UPDATE zones SET zone_code='鹿児島県' WHERE zone_country_id='107' AND zone_code='46' AND zone_name='鹿児島県';
UPDATE zones SET zone_code='沖縄県' WHERE zone_country_id='107' AND zone_code='47' AND zone_name='沖縄県';
