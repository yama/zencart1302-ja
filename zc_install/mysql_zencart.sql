...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Product Price/Add to Cart Column Width', 'PRODUCTS_LIST_PRICE_WIDTH', '67', 'Define the width of the Price/Add to Cart column<br />Default= 125', '8', '8', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('Previous Next - Navigation Bar Position', 'PRODUCT_INFO_PREVIOUS_NEXT', '2', 'Location of Previous/Next Navigation Bar<br />0= off<br />1= Top of Page<br />2= Bottom of Page<br />3= Both Top and Bottom of Page', 18, 21, now(), now(), NULL, 'zen_cfg_select_drop_down(array(array(\'id\'=>\'0\', \'text\'=>\'Off\'), array(\'id\'=>\'1\', \'text\'=>\'Top of Page\'), array(\'id\'=>\'2\', \'text\'=>\'Bottom of Page\'), array(\'id\'=>\'3\', \'text\'=>\'Both Top & Bottom of Page\')),');
...
INSERT INTO layout_boxes (layout_template, layout_box_name, layout_box_status, layout_box_location, layout_box_sort_order, layout_box_sort_order_single, layout_box_status_single) VALUES ('default_template_settings', 'tell_a_friend.php', 0, 1, 65, 0, 0);
...
INSERT INTO layout_boxes (layout_template, layout_box_name, layout_box_status, layout_box_location, layout_box_sort_order, layout_box_sort_order_single, layout_box_status_single) VALUES ('template_default', 'tell_a_friend.php', 0, 1, 65, 0, 0);
...
INSERT INTO layout_boxes (layout_template, layout_box_name, layout_box_status, layout_box_location, layout_box_sort_order, layout_box_sort_order_single, layout_box_status_single) VALUES ('classic', 'tell_a_friend.php', 0, 1, 65, 0, 0);
...
UPDATE configuration_group SET configuration_group_title = '¾¦ÉÊ¥Ú¡¼¥¸¤ÎÀßÄê', configuration_group_description = '¾¦ÉÊ¾ðÊó¤ÎÉ½¼¨¤Ë¤Ä¤¤¤Æ³Æ¼ï¤ÎÀßÄê¤ò¤·¤Þ¤¹¡£' WHERE  configuration_group_id = '18';
UPDATE configuration_group SET configuration_group_title = '¶¦ÄÌ¥ì¥¤¥¢¥¦¥È¤ÎÀßÄê', configuration_group_description = '¥·¥ç¥Ã¥×¤ÎÉ½¼¨¥ì¥¤¥¢¥¦¥È¤Ë¤Ä¤¤¤Æ³Æ¼ï¤ÎÀßÄê¤ò¤·¤Þ¤¹¡£' WHERE  configuration_group_id = '19';
...
UPDATE configuration_group SET configuration_group_title = 'ÄêÈÖ¥Ú¡¼¥¸¤ÎÉ½¼¨ÀßÄê', configuration_group_description = 'ÄêÈÖ¥Ú¡¼¥¸¤ÈTinyMCE¤Ê¤É¤Ë¤Ä¤¤¤Æ³Æ¼ï¤ÎÀßÄê¤ò¤·¤Þ¤¹¡£' WHERE  configuration_group_id = '25';
...
UPDATE configuration SET configuration_title='Âç·¿¥Ñ¥Ã¥±¡¼¥¸¤ÎÉ÷ÂÞ - Âç¤­¤µ¡¦½ÅÎÌ', configuration_description='Âç¤­¤Ê¥Ñ¥Ã¥±¡¼¥¸¤ÎÉ÷ÂÞ(¤Õ¤¦¤¿¤¤¡§Âç¤­¤µ¤È½ÅÎÌ)¤òÀßÄê¤·¤Þ¤¹¡£<br />\r\nÎã¡§10% + 1lb 10:1<br />\r\n10% + 0lbs 10:0<br />\r\n0% + 5lbs 0:5<br />\r\n0% + 0lbs 0:0' WHERE configuration_key='SHIPPING_BOX_PADDING';
...
UPDATE configuration SET configuration_title='Äã³Û¾¦ÉÊ¼è°·¤¤¼ê¿ôÎÁ¤Ï¥Ð¡¼¥Á¥ã¥ë¾¦ÉÊ¤Ë¤ÏÈóÅ¬ÍÑ', configuration_description='¥«¡¼¥ÈÆâ¤¬¥Ð¡¼¥Á¥ã¥ë¾¦ÉÊ¤À¤±¤ÎºÝ¤Ë¡¢Äã³Û¾¦ÉÊ¼è°·¤¤¼ê¿ôÎÁ¤òÄ§¼ý¤¹¤ë¤«¤É¤¦¤«¤òÀßÄê¤·¤Þ¤¹¡£' WHERE configuration_key='MODULE_ORDER_TOTAL_LOWORDERFEE_VIRTUAL';
...
UPDATE configuration SET configuration_title='¥Ð¥Ê¡¼É½¼¨¥°¥ë¡¼¥× - ¥µ¥¤¥É¥Ü¥Ã¥¯¥¹Æâ¥Ð¥Ê¡¼¥Ü¥Ã¥¯¥¹', configuration_description='¤É¤Î¥Ð¥Ê¡¼¥°¥ë¡¼¥×¤ò¥µ¥¤¥É¥Ü¥Ã¥¯¥¹Æâ¥Ð¥Ê¡¼¥Ü¥Ã¥¯¥¹¤Ë»ÈÍÑ¤·¤Þ¤¹¤«? »È¤ï¤Ê¤¤¾ì¹ç¤ÏÌ¤µ­Æþ¤Ë¤·¤Þ¤¹¡£<br />\r\n¥Ç¥Õ¥©¥ë¥È¤Î¥°¥ë¡¼¥×¤ÏSideBox-Banners¤Ç¤¹¡£<br />\r\n<br />\r\n¥Ð¥Ê¡¼É½¼¨¥°¥ë¡¼¥×¤Ï1¤Ä(1¥Ð¥Ê¡¼¥°¥ë¡¼¥×)¤Þ¤¿¤ÏÊ£¿ô(¥Þ¥ë¥Á¥Ð¥Ê¡¼¥°¥ë¡¼¥×)¤Ë¤¹¤ë¤³¤È¤â¤Ç¤­¤Þ¤¹¡£¥Þ¥ë¥Á¥Ð¥Ê¡¼¥°¥ë¡¼¥×¤òÉ½¼¨¤¹¤ë¤¿¤á¤Ë¤Ï¥°¥ë¡¼¥×Ì¾¤ò¥³¥í¥ó(<strong>:</strong>)¤Ç¶èÀÚ¤Ã¤ÆÆþÎÏ¤·¤Þ¤¹¡£<br />\r\nÎã¡§Wide-Banners:SideBox-Banners' WHERE configuration_key='SHOW_BANNERS_GROUP_SET7';
UPDATE configuration SET configuration_title='¥Ð¥Ê¡¼É½¼¨¥°¥ë¡¼¥× - ¥µ¥¤¥É¥Ü¥Ã¥¯¥¹Æâ¥Ð¥Ê¡¼¥Ü¥Ã¥¯¥¹2', configuration_description='¤É¤Î¥Ð¥Ê¡¼¥°¥ë¡¼¥×¤ò¥µ¥¤¥É¥Ü¥Ã¥¯¥¹Æâ¥Ð¥Ê¡¼¥Ü¥Ã¥¯¥¹¤Ë»ÈÍÑ¤·¤Þ¤¹¤«? »È¤ï¤Ê¤¤¾ì¹ç¤ÏÌ¤µ­Æþ¤Ë¤·¤Þ¤¹¡£<br />\r\n¥Ç¥Õ¥©¥ë¥È¤Î¥°¥ë¡¼¥×¤ÏSideBox-Banners¤Ç¤¹¡£<br />\r\n<br />\r\n¥Ð¥Ê¡¼É½¼¨¥°¥ë¡¼¥×¤Ï1¤Ä(1¥Ð¥Ê¡¼¥°¥ë¡¼¥×)¤Þ¤¿¤ÏÊ£¿ô(¥Þ¥ë¥Á¥Ð¥Ê¡¼¥°¥ë¡¼¥×)¤Ë¤¹¤ë¤³¤È¤â¤Ç¤­¤Þ¤¹¡£¥Þ¥ë¥Á¥Ð¥Ê¡¼¥°¥ë¡¼¥×¤òÉ½¼¨¤¹¤ë¤¿¤á¤Ë¤Ï¥°¥ë¡¼¥×Ì¾¤ò¥³¥í¥ó(<strong>:</strong>)¤Ç¶èÀÚ¤Ã¤ÆÆþÎÏ¤·¤Þ¤¹¡£<br />\r\nÎã¡§Wide-Banners:SideBox-Banners' WHERE configuration_key='SHOW_BANNERS_GROUP_SET8';
...
UPDATE configuration SET configuration_title='¥«¥Æ¥´¥ê/¾¦ÉÊ¤Î¥½¡¼¥È½ç', configuration_description='¥«¥Æ¥´¥ê/¾¦ÉÊ¤Î¥½¡¼¥È½ç¤òÀßÄê¤·¤Þ¤¹¡£<br />0= ¥«¥Æ¥´¥ê/¾¦ÉÊ ¥½¡¼¥È½ç/Ì¾Á°<br />1= ¥«¥Æ¥´¥ê/¾¦ÉÊ Ì¾Á°<br />2= ¾¦ÉÊ¥³¡¼¥É<br />3= ¾¦ÉÊ¿ôÎÌ+, ¾¦ÉÊÌ¾<br />4= ¾¦ÉÊ¿ôÎÌ-, ¾¦ÉÊÌ¾<br />5= ¾¦ÉÊ²Á³Ê+, ¾¦ÉÊÌ¾<br />6= ¾¦ÉÊ²Á³Ê+, ¾¦ÉÊÌ¾' WHERE configuration_key='CATEGORIES_PRODUCTS_SORT_ORDER';
UPDATE configuration SET configuration_title='¥ª¥×¥·¥ç¥óÌ¾/¥ª¥×¥·¥ç¥óÃÍ¤ÎÄÉ²Ã¡¦¥³¥Ô¡¼¡¦ºï½ü', configuration_description='¥ª¥×¥·¥ç¥óÌ¾/¥ª¥×¥·¥ç¥óÃÍ¤ÎÄÉ²Ã¡¦¥³¥Ô¡¼¡¦ºï½ü¤Îµ¡Ç½¤Ë¤Ä¤¤¤Æ¤Î¥°¥í¡¼¥Ð¥ë¤ÊÀßÄê¤ò¹Ô¤¤¤Þ¤¹¡£<br />0= µ¡Ç½¤ò±£¤¹<br />1= µ¡Ç½¤òÉ½¼¨¤¹¤ë<br />2= ¾¦ÉÊ¥³¡¼¥É' WHERE configuration_key='OPTION_NAMES_VALUES_GLOBAL_STATUS';
...
UPDATE product_type_layout  SET  configuration_title='¥Ð¡¼¥Á¥ã¥ë¾¦ÉÊ¤Î¥Ç¥Õ¥©¥ë¥È¥¹¥Æ¡¼¥¿¥¹ - ¿·¾¦ÉÊÄÉ²Ã»þ', configuration_description='¿·¾¦ÉÊ¤òÄÉ²Ã¤¹¤ë»þ¤Î¡¢¥Ð¡¼¥Á¥ã¥ë¾¦ÉÊ¤Î¥Ç¥Õ¥©¥ë¥È¥¹¥Æ¡¼¥¿¥¹¤òON¤Ë¤·¤Þ¤¹¤«¡©' WHERE configuration_title='Product Virtual Default Status - Skip Shipping Address - When adding new products?' AND configuration_description='Default Virtual Product status to be ON when adding new products?';
